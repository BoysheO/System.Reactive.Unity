...
namespace System.Reactive.Linq
{
    ...
    internal partial class QueryLanguage
    {
        ...
        {
            return Catch_((IObservable<TSource>[])new[] { first, second });
        }
        ...
        {
            return Concat_((IObservable<TSource>[])new[] { first, second });
        }
        ...
        {
            return OnErrorResumeNext_((IObservable<TSource>[])new[] { first, second });
        }
